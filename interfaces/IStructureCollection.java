...
public interface IStructureCollection<T> {
    /**
     * @return True when <b>Collection</b> is full. False otherwise.
     */
    boolean isFull();
    /**
     * @return True when <b>Collection</b> is empty. False otherwise.
     */
    boolean isEmpty();
    /**
     * @return Current amount of elements present at an <b>Collection</b>.
     */
    int size();
    /**
     * @return First element at an <b>Collection</b>.
     */
    T first();
    /**
     * @return Last element at an <b>Collection</b>.
     */
    T last();
    /**
     * @implNote Clear all elements at an <b>Collection</b>.
     */
    void clear();
    /**
